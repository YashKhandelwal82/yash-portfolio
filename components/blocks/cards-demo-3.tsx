  ...
  return (
    <Card>
      ...
      <div className="flex flex-col items-center justify-center text-center mt-4">
        ...
        <CardDescription>
          Full-stack e-commerce platform with vendor dashboard, shopping cart, and secure PayPal checkout. Achieved 99.9% uptime and sub-200ms API response time with optimized backend.
        </CardDescription>
