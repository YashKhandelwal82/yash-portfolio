  ...
  return (
    <Card>
      ...
      <div className="flex flex-col items-center justify-center text-center mt-4">
        ...
        <CardDescription>
          Interactive web-based visualization tool demonstrating sorting algorithms like Bubble Sort, Merge Sort, and Quick Sort in real-time.
          Implemented 5 algorithms with customizable speed and array size.
        </CardDescription>
        <div className="flex gap-3 mt-3">
          <a
            href="https://github.com/YashKhandelwal82/Sorting-Visualizer"
            target="_blank"
